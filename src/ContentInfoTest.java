...
class ContentInfoTest {
    ...
    void TestIsAudio() {
        //text content
        ContentInfo myAudioContent = null;
        try {
            myAudioContent = new ContentInfo("https://www.ccis.northeastern.edu/home/pgust/classes/cs5500/2020/Fall/resources/assignment-3/3.258start.wav");
        } catch (MalformedURLException e) {
            fail("unexpected MalformedURLException");
        }

        try {
            assertTrue(myAudioContent.isAudio());
        } catch (IOException e) {
            fail("unexpected IOException");
        }
        ...
        ContentInfo myImageContent = null;
        try {
            myImageContent = new ContentInfo("https://www.ccis.northeastern.edu/home/pgust/classes/cs5500/2020/Fall/resources/assignment-3/500x200.png");
        } catch (MalformedURLException e) {
            fail("unexpected MalformedURLException");
        }
        try {
            assertFalse(myImageContent.isAudio());
        } catch (IOException e) {
            fail("unexpected IOException");
        }
    }
    ...
    @Test
    void TestGetAudioDuration() {
        ContentInfo myContent = null;
        try {
            myContent = new ContentInfo("https://www.ccis.northeastern.edu/home/pgust/classes/cs5500/2020/Fall/resources/assignment-3/3.258start.wav");
        } catch (MalformedURLException e) {
            fail("unexpected MalformedURLException");
        }

        double myAudioDuration = 0;
        try {
            myAudioDuration = myContent.getAudioDuration();
        } catch (Exception e) {
            fail("IOException with the UnsupportedAudioFileException");
        }

        assertEquals(3.258, myAudioDuration);
    }
